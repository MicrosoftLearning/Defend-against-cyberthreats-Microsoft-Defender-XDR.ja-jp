...
1. [アクセス許可] 領域で、**[役割]** を選択します。

1. **[ロールを有効にする]** ボタンを選択します。

1. **[+ 役割を追加]** を選択します。

1. [役割を追加] ダイアログで、以下を入力します。
...
1. 上部の **[割り当てられたユーザー グループ]** タブを選択します。 **[sg-IT]** を選択し、**[選択したグループを追加する]** を選択します。 これが *[この役割を持つ Azure AD ユーザー グループ]* の下に表示されることを確認します。
